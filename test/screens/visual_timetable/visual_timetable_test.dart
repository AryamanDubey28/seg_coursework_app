...
void main() {
  ...
  testWidgets(
      'Search bar filters picture grid.',
      (WidgetTester tester) async {
    mockNetworkImagesFor(() async {
      ...
      expect(
          find.byKey(const ValueKey("gridImage0")), findsOneWidget);
      ...
      expect(
          find.byKey(const ValueKey("gridImage0")), findsNothing);
  ...
  testWidgets(
      'Long pressing a timetable item crosses it out.',
      (WidgetTester tester) async {
    mockNetworkImagesFor(() async {
