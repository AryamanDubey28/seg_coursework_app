...
void main() {
  testWidgets('PictureGrid is shown by default', 
  ...
  testWidgets('PictureGrid is hidden then reshown with the FloatingActionButton', 
    (WidgetTester tester) async {
      mockNetworkImagesFor(() async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(const VisualTimetableInterface());
  ...
  testWidgets('PictureGrid is hidden when 5 images are chosen and shown when less are chosen', 
    (WidgetTester tester) async {
      mockNetworkImagesFor(() async {
  ...
  testWidgets('Add to list of lists button is shown when 2 or more images are added to the timetable.', 
    (WidgetTester tester) async {
      mockNetworkImagesFor(() async {
    ...
    expect(find.byKey(const ValueKey("addToListOfListsButton")), findsNothing);
    ...
    expect(find.byKey(const ValueKey("addToListOfListsButton")), findsOneWidget);
