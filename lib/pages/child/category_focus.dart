...
// This class is the interface that shows the category in details to the child user
// and allows them to click on images to speak their text.

class CategoryFocus extends StatefulWidget {
  // UNCOMMENT AFTER ADDING A QUEERY TO GET IMAGES
  // String categoryTitle;
  // ClickableImage categoryImage;
  // List<ClickableImage> images = [];
  const CategoryFocus({Key? key}) : super(key: key);
  ...
  @override
  State<CategoryFocus> createState() => _CategoryFocus();
}

/// The page is for the child to select choice boards
class _CategoryFocus extends State<CategoryFocus>
